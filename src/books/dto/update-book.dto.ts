...
export class UpdateBookDto {
      ...
      @MaxLength(500, { message: "El title no puede superar los 500 caracteres de largo" })
      @ApiProperty({
            nullable: false,
            required: true,
            type: String,
      ...
      constructor(idBook: number, title: string, availability: boolean, price: number, idGender: number, idEditorial: number, imageUrl: string) {
            this.idBook = idBook;
            this.title = title;
